...
<body bgcolor="#ddd">
<a href="index.html"><h1><font size="5000" color="#4B8DF8">
$\ \ \Huge{e}\Large{\mathrm{xpressionizr}}$
</font></h1></a>
<br><br>
<blockquote><input type="file" id="file" class="bluebtn" /></blockquote>
<form style="display:none" method="post" action="ocr.php" enctype="multipart/form-data">
<input name="file" type="hidden" id="sendfile" /><input type="submit" id="submitform" />
</form>
